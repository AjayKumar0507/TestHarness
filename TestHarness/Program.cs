...
namespace TestHarness
{
    public class Program 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please press the number key associated with  the class you wish to test");
            ...
            WriteHeadingToScreen($"Classs: '{typeChoice}");
            WriteHeadingToScreen("Please enter the number associated with the method you wish to test");
        ...
        private static object[] ReturnParameterValueInputAsObjectArray(ParameterInfo[] parameters)
        {
            ...
            {
                WriteHeadingToScreen($"Please enter a value for the parameter named '{parameterInfo.Name}'");
        ...
        private static void WriteHeadingToScreen(string promptText)
        {
